      ...
      <div className="c-info">
        <div className="c-box">
          <div className="c-header">
            ...
            <img className="ch-icn" src="/Assets/view-all.svg" alt="ViewAll" />
          </div>
          <div className="m-box">
        ...
        <div className="ch">
          <div className="msg-box fr">
            ...
            <div className="msg-info">
              ...
              <p className="msg">This is a test message, not an online one.</p>
            </div>
          </div>
          <div className="msg-box to">
            ...
            <div className="msg-info">
              ...
              <p className="msg">This is a test response, not an online one.</p>
            </div>
          </div>
        </div>
